...
public class Deposit  extends JFrame implements ActionListener{
    ...
    Deposit(){
        ...
        JLabel text = new JLabel("Deposit");
        ...
        JLabel lblmoney = new JLabel("Deposit Balance");
        ...
        deposit.setBounds(150,330,100,30);
        ...
        if(ae.getSource() == check){
           ...
           try {
                ...
                while(rs3.next()){
                    ...
                    String depoosit = tfmoney.getText();
                    int depositmoney = Integer.parseInt(balance) + Integer.parseInt(depoosit);
                    
                    
                    String query2 = "update account set balance = '"+depositmoney+"' where name = '"+name+"' and account_no = '"+accountno+"'  ";
                
                     c.s.executeUpdate(query2);
                     
                     String query3 = "insert into transactions values('"+accountno+"','deposit','"+time+"','+"+depoosit+"','"+depositmoney+"')";
                     ...
                     statementArea.append("Account No: " + accountno + " \n"
                             +"Name: " + name + "\n"
                                     +"Money Withdrawed:"+depoosit +" \n"
                                             +"Total Balance: " + depositmoney + "\n");
